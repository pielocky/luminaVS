...
requirements = python3,kivy==2.1.0,numpy==1.24.1,opencv-python-headless==4.5.5.64,pillow==9.5.0,pyzbar==0.1.9,gtts==2.3.1,playsound==1.2.2,android, android_numpy
